...
function scegliGioco(i){
	numeroGioco=parseInt(i);
	if(numeroGioco>4){
	...
	if(i==1){
		document.getElementById("img").src = "img/LavoriInCorso.jpg";
		document.getElementById("titolo").innerHTML = "x. xxxxxxxxx ";
		...
		chiave = "Chiave della soluzione";
		chiaveSenzaSpazi = "chaive senza spazi";
		chiaveSpiegata = "soluzione spiegata per benino";
	}
	else if (i==2){
